...
INSERT INTO account (id, version, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at) VALUES (nextval('seq_gen_sequence'), 1, 'NORMAL', false, 'ACTIVE', 'steve.jobs@gmail.com', 0, 'pl', 'clientemployee', '$2a$12$X7QVm.XkCx3l97z0/LbxzewopH6ift/IU9kDPfq834MYPfV7w27pe', (SELECT id FROM person WHERE first_name = 'Steve'), now());
...
INSERT INTO account (id, version, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at) VALUES (nextval('seq_gen_sequence'), 1, 'NORMAL', false, 'ACTIVE', 'adam.mickiewicz@gmail.com', 0, 'pl', 'client', '$2a$12$X7QVm.XkCx3l97z0/LbxzewopH6ift/IU9kDPfq834MYPfV7w27pe', (SELECT id FROM person WHERE first_name = 'Adam'), now());
...
INSERT INTO account (id, version, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at) VALUES (nextval('seq_gen_sequence'), 1, 'NORMAL', false, 'ACTIVE', 'cyprian.norwid@gmail.com', 0, 'pl', 'salesrep', '$2a$12$X7QVm.XkCx3l97z0/LbxzewopH6ift/IU9kDPfq834MYPfV7w27pe', (SELECT id FROM person WHERE first_name = 'Cyprian'), now());
