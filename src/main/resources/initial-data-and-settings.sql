...
INSERT INTO account (id, version, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at) VALUES (nextval('seq_gen_sequence'), 1, 'NORMAL', false, 'ACTIVE', 'admin@gmail.com', 0, 'pl', 'administrator', '$2a$12$25FtP.RT6GzbYGrZ9UHRVOEoZSI2P8R9hj6yOrKjaxipI05IXUXJC', (SELECT id FROM person WHERE first_name = 'Jan'), now());
...
INSERT INTO account (id, version, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at) VALUES (nextval('seq_gen_sequence'), 1, 'NORMAL', false, 'ACTIVE', 'steve.jobs@gmail.com', 0, 'pl', 'clientemployee', '$2a$12$pcaYxmHossXSpP0ElZFyseS5KOxJyDKlaJj8v3lZ7YEj4W3sgySbi', (SELECT id FROM person WHERE first_name = 'Steve'), now());
...
INSERT INTO account (id, version, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at) VALUES (nextval('seq_gen_sequence'), 1, 'NORMAL', false, 'ACTIVE', 'adam.mickiewicz@gmail.com', 0, 'pl', 'client', '$2a$12$eZe8v65ksH7chB8oqKidEeyMBJ2yCjmZbdf6f16Lro3832Z95T/MO', (SELECT id FROM person WHERE first_name = 'Adam'), now());
