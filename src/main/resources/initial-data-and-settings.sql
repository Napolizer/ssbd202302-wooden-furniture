...
INSERT INTO account_search_settings (id, version, archive, created_at, displayed_accounts, search_keyword, search_page, sort_ascending, sort_by) VALUES (nextval('seq_gen_sequence'), 1, false, now(), 10, '', 1, true, 'LOGIN');
INSERT INTO account (id, version, time_zone, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at, account_search_settings_id) VALUES (nextval('seq_gen_sequence'), 1, 'EUROPE_WARSAW', 'NORMAL', false, 'ACTIVE', 'admin@gmail.com', 0, 'pl', 'administrator', '$2a$12$X7QVm.XkCx3l97z0/LbxzewopH6ift/IU9kDPfq834MYPfV7w27pe', (SELECT id FROM person WHERE first_name = 'Jan'), now(), (SELECT id FROM account_search_settings WHERE sort_by = 'LOGIN'));
...
INSERT INTO account_search_settings (id, version, archive, created_at, displayed_accounts, search_keyword, search_page, sort_ascending, sort_by) VALUES (nextval('seq_gen_sequence'), 1, false, now(), 10, '', 1, true, 'EMAIL');
INSERT INTO account (id, version, time_zone,type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at, account_search_settings_id) VALUES (nextval('seq_gen_sequence'), 1, 'EUROPE_WARSAW', 'NORMAL', false, 'ACTIVE', 'steve.jobs@gmail.com', 0, 'pl', 'clientemployee', '$2a$12$X7QVm.XkCx3l97z0/LbxzewopH6ift/IU9kDPfq834MYPfV7w27pe', (SELECT id FROM person WHERE first_name = 'Steve'), now(), (SELECT id FROM account_search_settings WHERE sort_by = 'EMAIL'));
...
INSERT INTO account_search_settings (id, version, archive, created_at, displayed_accounts, search_keyword, search_page, sort_ascending, sort_by) VALUES (nextval('seq_gen_sequence'), 1, false, now(), 10, '', 1, true, 'ACCESSLEVEL');
INSERT INTO account (id, version, time_zone, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at, account_search_settings_id) VALUES (nextval('seq_gen_sequence'), 1, 'EUROPE_WARSAW', 'NORMAL', false, 'ACTIVE', 'adam.mickiewicz@gmail.com', 0, 'pl', 'client', '$2a$12$X7QVm.XkCx3l97z0/LbxzewopH6ift/IU9kDPfq834MYPfV7w27pe', (SELECT id FROM person WHERE first_name = 'Adam'), now(), (SELECT id FROM account_search_settings WHERE sort_by = 'EMAIL'));
...
INSERT INTO account_search_settings (id, version, archive, created_at, displayed_accounts, search_keyword, search_page, sort_ascending, sort_by) VALUES (nextval('seq_gen_sequence'), 1, false, now(), 10, 'Adam', 1, true, 'LOGIN');
INSERT INTO account (id, version, time_zone, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at, account_search_settings_id) VALUES (nextval('seq_gen_sequence'), 1, 'EUROPE_WARSAW', 'NORMAL', false, 'ACTIVE', 'juliusz.slowacki@gmail.com', 0, 'pl', 'employee', '$2a$12$X7QVm.XkCx3l97z0/LbxzewopH6ift/IU9kDPfq834MYPfV7w27pe', (SELECT id FROM person WHERE first_name = 'Juliusz'), now(), (SELECT id FROM account_search_settings WHERE search_keyword = 'Adam'));
...
INSERT INTO account_search_settings (id, version, archive, created_at, displayed_accounts, search_keyword, search_page, sort_ascending, sort_by) VALUES (nextval('seq_gen_sequence'), 1, false, now(), 10, 'Juliusz', 1, true, 'LOGIN');
INSERT INTO account (id, version, time_zone, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id, created_at, account_search_settings_id) VALUES (nextval('seq_gen_sequence'), 1, 'EUROPE_WARSAW', 'NORMAL', false, 'ACTIVE', 'cyprian.norwid@gmail.com', 0, 'pl', 'salesrep', '$2a$12$X7QVm.XkCx3l97z0/LbxzewopH6ift/IU9kDPfq834MYPfV7w27pe', (SELECT id FROM person WHERE first_name = 'Cyprian'), now(), (SELECT id FROM person WHERE first_name = 'Juliusz'), now(), (SELECT id FROM account_search_settings WHERE search_keyword = 'Juliusz'));
