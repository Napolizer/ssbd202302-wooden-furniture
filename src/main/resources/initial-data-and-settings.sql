...
INSERT INTO product (id, version, amount, archive, available, color, created_at, image_url, price, weight, weight_in_package, wood_type, furniture_depth, furniture_height, furniture_width, package_depth, package_height, package_width, product_group_id) VALUES (1, 1, 10, false, true, 'RED', now(), null, 99.99, 2.5, 3.0, 'OAK', 2.2, 1.8, 1.5, 2.5, 1.9, 1.6, (SELECT id from product_group WHERE name = 'Single SLIPWEL 1'));
INSERT INTO product (id, version, amount, archive, available, color, created_at, image_url, price, weight, weight_in_package, wood_type, furniture_depth, furniture_height, furniture_width, package_depth, package_height, package_width, product_group_id) VALUES (2, 1, 15, false, true, 'BLACK', now(), null, 99.99, 2.5, 3.0, 'OAK', 2.2, 1.8, 1.5, 2.5, 1.9, 1.6, (SELECT id from product_group WHERE name = 'Single SLIPWEL 1'));
INSERT INTO product (id, version, amount, archive, available, color, created_at, image_url, price, weight, weight_in_package, wood_type, furniture_depth, furniture_height, furniture_width, package_depth, package_height, package_width, product_group_id) VALUES (3, 1, 259, false, true, 'BLACK', now(), null, 199.99, 5.0, 6.0, 'OAK', 2.2, 1.8, 3.0, 2.5, 1.9, 3.1, (SELECT id from product_group WHERE name = 'Double SLIPWEL 1'));
