...
@DisplayName("MOK.5 - Assign access level")
  ...
  class Positive {
    ...
    void shouldProperlyAddClientAccessLevelWhenAccountGotOnlyEmployeeAccessLevel() {
      given()
              .header("Authorization", "Bearer " + InitData.retrieveAdminToken())
              .when()
              .put("/account/id/" + InitData.retrieveAccountId("accounttoeditals") + "/accessLevel/Client")
              .then()
              .statusCode(200);
    }
  }
  ...
  class Negative {
    ...
    void failsToAddAccessLevelWhenAccessLevelIsInvalid() {
      given()
              .header("Authorization", "Bearer " + InitData.retrieveAdminToken())
              .when()
              .put("/account/id/" + InitData.retrieveAccountId("accounttoeditals") + "/accessLevel/NotValidAccessLevel")
              .then()
              .statusCode(400)
    ...
    void failsToAddAdministratorAccessLevel() {
      given()
              .header("Authorization", "Bearer " + InitData.retrieveAdminToken())
              .when()
              .put("/account/id/" + InitData.retrieveAccountId("accounttoeditals") + "/accessLevel/Administrator")
              .then()
              .statusCode(400)
    ...
    void failsToAddSalesRepWhenEmployeeIsAlreadyAssignedAccessLevel() {
      given()
              .header("Authorization", "Bearer " + InitData.retrieveAdminToken())
              .when()
              .put("/account/id/" + InitData.retrieveAccountId("accounttoeditals") + "/accessLevel/Sales_rep")
              .then()
              .statusCode(400)
