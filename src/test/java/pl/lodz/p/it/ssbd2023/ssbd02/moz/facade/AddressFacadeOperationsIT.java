...
//    return ShrinkWrap.create(WebArchive.class).addPackages(true, "pl.lodz.p.it.ssbd2023.ssbd02")
//        .addPackages(true, "org.postgresql").addPackages(true, "org.hamcrest")
//        .addAsResource(new File("src/test/resources/"), "");
//  }
//
//  @BeforeEach
//  public void init() throws SystemException, NotSupportedException {
//    address = Address.builder().archive(false).country("Polska").city("Lodz").street("Koszykowa").postalCode("90-000")
//        .streetNumber(12).build();
//    secondAddress =
//        Address.builder().archive(false).country("Poland").city("Warszawa").street("Pilsudskiego").postalCode("91-333")
...
//
//    Optional<Address> foundAddress1Optional =
//        foundAddresses.stream().filter(a -> a.getId().equals(savedAddress1.getId())).findFirst();
...
//
//    Optional<Address> foundAddress2Optional =
//        foundAddresses.stream().filter(a -> a.getId().equals(savedAddress2.getId())).findFirst();
...
//
//    Optional<Address> foundAddress1Optional =
//        foundPresentAddresses.stream().filter(a -> a.getId().equals(savedAddress1.getId())).findFirst();
//    assertThat(foundAddress1Optional.isPresent(), is(equalTo(true)));
//    Address foundAddress1 = foundAddress1Optional.get();
//
//    assertThat(foundAddress1, is(notNullValue()));
...
//
//    Optional<Address> foundAddress2Optional =
//        foundPresentAddresses.stream().filter(a -> a.getId().equals(savedAddress2.getId())).findFirst();
//    assertThat(foundAddress2Optional.isPresent(), is(equalTo(true)));
//    Address foundAddress2 = foundAddress2Optional.get();
//
//    assertThat(foundAddress2, is(notNullValue()));
