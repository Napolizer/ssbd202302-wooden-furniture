...
public class CryptHashUtilsTest {
    ...
    public void properlyVerifiesTwoIdenticalPasswords() {
        ...
        Assertions.assertEquals(true, CryptHashUtils.verifyPassword(password, hashed));
    }
    ...
    public void properlyVerifiesTwoDifferentPasswords() {
        ...
        Assertions.assertEquals(false, CryptHashUtils.verifyPassword(password1, hashed));
    }
    ...
    public void properlyVerifiesTwoSameVersions() {
        ...
        Assertions.assertEquals(true, CryptHashUtils.verifyVersion(version, hashed));
    }
    ...
    public void properlyVerifiesTwoDifferentVersions() {
        ...
        Assertions.assertEquals(false, CryptHashUtils.verifyVersion(version1, hashed));
    }
