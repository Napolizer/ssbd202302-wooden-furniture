...
//    assertThat(productWithUpdatedFurnitureDimensions.getFurnitureDimensions(),
//        is(equalTo(validProduct.getFurnitureDimensions())));
//    assertThat(productFacadeOperations.findAll().size(), is(equalTo(1)));
//  }
//
//  @Test
...
//    assertThat(productWithUpdatedPackageDimensions.getPackageDimensions(),
//        is(equalTo(validProduct.getPackageDimensions())));
//    assertThat(productFacadeOperations.findAll().size(), is(equalTo(1)));
//  }
//
//  @Test
