...
INSERT INTO account (id, version, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id) VALUES (nextval('seq_gen_sequence'), 1, 'NORMAL', false, 'ACTIVE', 'admin@gmail.com', 0, 'pl', 'admin', '$2a$12$xnPLkhbqOn/obTmNJ1xL/u5bWs5huYfkyoSKeLJpK/jjZL0H031RW', (SELECT id FROM person WHERE first_name = 'Admin'));
...
INSERT INTO account (id, version, type, archive, account_state, email, failed_login_counter, locale, login, password, person_id) VALUES (nextval('seq_gen_sequence'), 1, false, 'NORMAL', 'ACTIVE', 'user1@gmail.com', 0, 'pl', 'user1', '$2a$12$dandYnHSVGt/REAEm5Io3Ohrmhx6KLWiIiHGQ1ZPzAMB.fRyy69hK', (SELECT id FROM person WHERE first_name = 'User1'));
